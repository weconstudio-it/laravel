...
class UserGroupTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\UserGroup';
     ...
     */
    const COL_LEVEL = 'user_group.level';

    /**
     * the column name for the visible field
     */
    const COL_VISIBLE = 'user_group.visible';

    /**
     * the column name for the enabled field
     */
    const COL_ENABLED = 'user_group.enabled';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\UserGroup');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\UserGroup) { // it's a model object
