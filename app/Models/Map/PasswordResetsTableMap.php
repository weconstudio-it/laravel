...
use App\Models\PasswordResetsQuery;
...
class PasswordResetsTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\PasswordResets';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\PasswordResets');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\PasswordResets) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(PasswordResetsTableMap::DATABASE_NAME);
            $criteria->add(PasswordResetsTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PasswordResetsTableMap::COL_ID) && $criteria->keyContainsValue(PasswordResetsTableMap::COL_ID) ) {
