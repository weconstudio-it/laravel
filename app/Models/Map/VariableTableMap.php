...
class VariableTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Value', 'Validfrom', 'Validto', 'Description', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'value', 'validfrom', 'validto', 'description', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(VariableTableMap::COL_ID, VariableTableMap::COL_NAME, VariableTableMap::COL_VALUE, VariableTableMap::COL_VALIDFROM, VariableTableMap::COL_VALIDTO, VariableTableMap::COL_DESCRIPTION, VariableTableMap::COL_CREATED_AT, VariableTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'value', 'validFrom', 'validTo', 'description', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Value' => 2, 'Validfrom' => 3, 'Validto' => 4, 'Description' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'value' => 2, 'validfrom' => 3, 'validto' => 4, 'description' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(VariableTableMap::COL_ID => 0, VariableTableMap::COL_NAME => 1, VariableTableMap::COL_VALUE => 2, VariableTableMap::COL_VALIDFROM => 3, VariableTableMap::COL_VALIDTO => 4, VariableTableMap::COL_DESCRIPTION => 5, VariableTableMap::COL_CREATED_AT => 6, VariableTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'value' => 2, 'validFrom' => 3, 'validTo' => 4, 'description' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
