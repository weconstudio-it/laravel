...
*/
abstract class FailedJobs implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\FailedJobsTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\FailedJobs object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>FailedJobs</code> instance.  If
     * <code>obj</code> is an instance of <code>FailedJobs</code>, delegates to
     * <code>equals(FailedJobs)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|FailedJobs The current object, for fluid interface
     */
    ...
    /**
     * Get the [optionally formatted] temporal [failed_at] column value.
     *
     *
    ...
    public function getFailedAt($format = 'Y-m-d H:i:s')
    {
        if ($format === null) {
            ...
            return $this->failed_at instanceof \DateTime ? $this->failed_at->format($format) : null;
        }
    }
    ...
    public function setConnection($v)
    {
        ...
        if ($this->connection !== $v) {
            $this->connection = $v;
            $this->modifiedColumns[FailedJobsTableMap::COL_CONNECTION] = true;
        }
    ...
    public function setQueue($v)
    {
        ...
        if ($this->queue !== $v) {
            $this->queue = $v;
            $this->modifiedColumns[FailedJobsTableMap::COL_QUEUE] = true;
        }
    ...
    public function setPayload($v)
    {
        ...
        if ($this->payload !== $v) {
            $this->payload = $v;
            $this->modifiedColumns[FailedJobsTableMap::COL_PAYLOAD] = true;
        }
    ...
    /**
     * Sets the value of [failed_at] column to a normalized version of the date/time value specified.
     *
    ...
    public function setFailedAt($v)
    {
        ...
        if ($this->failed_at !== null || $dt !== null) {
            if ($this->failed_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->failed_at->format("Y-m-d H:i:s")) {
                $this->failed_at = $dt === null ? null : clone $dt;
                $this->modifiedColumns[FailedJobsTableMap::COL_FAILED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 5; // 5 = FailedJobsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\FailedJobs'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFailedJobsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see FailedJobs::setDeleted()
     * @see FailedJobs::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFailedJobsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FailedJobsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FailedJobsTableMap::COL_QUEUE)) {
            $modifiedColumns[':p' . $index++]  = 'queue';
        }
        if ($this->isColumnModified(FailedJobsTableMap::COL_PAYLOAD)) {
    ...
    {
        $pos = FailedJobsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['FailedJobs'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\App\Models\FailedJobs
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\FailedJobs The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FailedJobsTableMap::COL_QUEUE)) {
            $criteria->add(FailedJobsTableMap::COL_QUEUE, $this->queue);
        }
        if ($this->isColumnModified(FailedJobsTableMap::COL_PAYLOAD)) {
            $criteria->add(FailedJobsTableMap::COL_PAYLOAD, $this->payload);
        }
        if ($this->isColumnModified(FailedJobsTableMap::COL_FAILED_AT)) {
    ...
    {
        $criteria = ChildFailedJobsQuery::create();
        $criteria->add(FailedJobsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\FailedJobs (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setFailedAt($this->getFailedAt());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\FailedJobs Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(FailedJobsTableMap::DEFAULT_STRING_FORMAT);
    }
