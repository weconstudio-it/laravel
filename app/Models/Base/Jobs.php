...
*/
abstract class Jobs implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\JobsTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\Jobs object.
     */
    ...
    /**
     * Compares this with another <code>Jobs</code> instance.  If
     * <code>obj</code> is an instance of <code>Jobs</code>, delegates to
     * <code>equals(Jobs)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Jobs The current object, for fluid interface
     */
    ...
    public function setQueue($v)
    {
        ...
        if ($this->queue !== $v) {
            $this->queue = $v;
            $this->modifiedColumns[JobsTableMap::COL_QUEUE] = true;
        }
    ...
    public function setPayload($v)
    {
        ...
        if ($this->payload !== $v) {
            $this->payload = $v;
            $this->modifiedColumns[JobsTableMap::COL_PAYLOAD] = true;
        }
    ...
    public function setAttempts($v)
    {
        ...
        if ($this->attempts !== $v) {
            $this->attempts = $v;
            $this->modifiedColumns[JobsTableMap::COL_ATTEMPTS] = true;
        }
    ...
    public function setReserved($v)
    {
        ...
        if ($this->reserved !== $v) {
            $this->reserved = $v;
            $this->modifiedColumns[JobsTableMap::COL_RESERVED] = true;
        }
    ...
    public function setReservedAt($v)
    {
        ...
        if ($this->reserved_at !== $v) {
            $this->reserved_at = $v;
            $this->modifiedColumns[JobsTableMap::COL_RESERVED_AT] = true;
        }
    ...
    public function setAvailableAt($v)
    {
        ...
        if ($this->available_at !== $v) {
            $this->available_at = $v;
            $this->modifiedColumns[JobsTableMap::COL_AVAILABLE_AT] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[JobsTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[JobsTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 9; // 9 = JobsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\Jobs'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildJobsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildJobsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(JobsTableMap::COL_CREATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(JobsTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                JobsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(JobsTableMap::COL_PAYLOAD)) {
            $modifiedColumns[':p' . $index++]  = 'payload';
        }
        if ($this->isColumnModified(JobsTableMap::COL_ATTEMPTS)) {
            $modifiedColumns[':p' . $index++]  = 'attempts';
        }
        if ($this->isColumnModified(JobsTableMap::COL_RESERVED)) {
            $modifiedColumns[':p' . $index++]  = 'reserved';
        }
        if ($this->isColumnModified(JobsTableMap::COL_RESERVED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'reserved_at';
        }
        if ($this->isColumnModified(JobsTableMap::COL_AVAILABLE_AT)) {
            $modifiedColumns[':p' . $index++]  = 'available_at';
        }
        if ($this->isColumnModified(JobsTableMap::COL_CREATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'reserved':
                        ...
                        break;
                    case 'reserved_at':
                        $stmt->bindValue($identifier, $this->reserved_at, PDO::PARAM_INT);
                        break;
                    case 'available_at':
                        $stmt->bindValue($identifier, $this->available_at, PDO::PARAM_INT);
                        break;
                    case 'created_at':
    ...
    {
        $pos = JobsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Jobs'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Jobs The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JobsTableMap::COL_PAYLOAD)) {
            $criteria->add(JobsTableMap::COL_PAYLOAD, $this->payload);
        }
        if ($this->isColumnModified(JobsTableMap::COL_ATTEMPTS)) {
            $criteria->add(JobsTableMap::COL_ATTEMPTS, $this->attempts);
        }
        if ($this->isColumnModified(JobsTableMap::COL_RESERVED)) {
            $criteria->add(JobsTableMap::COL_RESERVED, $this->reserved);
        }
        if ($this->isColumnModified(JobsTableMap::COL_RESERVED_AT)) {
            $criteria->add(JobsTableMap::COL_RESERVED_AT, $this->reserved_at);
        }
        if ($this->isColumnModified(JobsTableMap::COL_AVAILABLE_AT)) {
            $criteria->add(JobsTableMap::COL_AVAILABLE_AT, $this->available_at);
        }
        if ($this->isColumnModified(JobsTableMap::COL_CREATED_AT)) {
            $criteria->add(JobsTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(JobsTableMap::COL_UPDATED_AT)) {
    ...
    {
        $criteria = ChildJobsQuery::create();
        $criteria->add(JobsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Jobs (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setReservedAt($this->getReservedAt());
        $copyObj->setAvailableAt($this->getAvailableAt());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Jobs Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(JobsTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildJobs The current object (for fluent API support)
     */
