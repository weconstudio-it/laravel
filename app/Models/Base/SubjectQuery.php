 ...
 * @method     ChildSubjectQuery orderByProvince($order = Criteria::ASC) Order by the province column
 * @method     ChildSubjectQuery orderByCountry($order = Criteria::ASC) Order by the country column
 * @method     ChildSubjectQuery orderByPhone($order = Criteria::ASC) Order by the phone column
 * @method     ChildSubjectQuery orderByFax($order = Criteria::ASC) Order by the fax column
 ...
 * @method     ChildSubjectQuery groupByProvince() Group by the province column
 * @method     ChildSubjectQuery groupByCountry() Group by the country column
 * @method     ChildSubjectQuery groupByPhone() Group by the phone column
 * @method     ChildSubjectQuery groupByFax() Group by the fax column
 ...
 * @method     ChildSubject findOneByProvince(string $province) Return the first ChildSubject filtered by the province column
 * @method     ChildSubject findOneByCountry(string $country) Return the first ChildSubject filtered by the country column
 * @method     ChildSubject findOneByPhone(string $phone) Return the first ChildSubject filtered by the phone column
 ...
 * @method     ChildSubject requireOneByProvince(string $province) Return the first ChildSubject filtered by the province column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSubject requireOneByCountry(string $country) Return the first ChildSubject filtered by the country column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSubject requireOneByPhone(string $phone) Return the first ChildSubject filtered by the phone column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSubject requireOneByFax(string $fax) Return the first ChildSubject filtered by the fax column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSubject[]|ObjectCollection findByProvince(string $province) Return ChildSubject objects filtered by the province column
 * @method     ChildSubject[]|ObjectCollection findByCountry(string $country) Return ChildSubject objects filtered by the country column
 * @method     ChildSubject[]|ObjectCollection findByPhone(string $phone) Return ChildSubject objects filtered by the phone column
 * @method     ChildSubject[]|ObjectCollection findByFax(string $fax) Return ChildSubject objects filtered by the fax column
...
abstract class SubjectQuery extends ModelCriteria
{
    ...
    public function filterByFirstName($firstName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SubjectTableMap::COL_FIRST_NAME, $firstName, $comparison);
    }
    ...
    public function filterByAddress($address = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SubjectTableMap::COL_ADDRESS, $address, $comparison);
    }
    ...
    public function filterByZip($zip = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SubjectTableMap::COL_ZIP, $zip, $comparison);
    }
    ...
    public function filterByCity($city = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SubjectTableMap::COL_CITY, $city, $comparison);
    }
    ...
    public function filterByProvince($province = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SubjectTableMap::COL_PROVINCE, $province, $comparison);
    }
    ...
    public function filterByCountry($country = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SubjectTableMap::COL_COUNTRY, $country, $comparison);
    }
    ...
    public function filterByPhone($phone = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SubjectTableMap::COL_PHONE, $phone, $comparison);
    }
    ...
    public function filterByFax($fax = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SubjectTableMap::COL_FAX, $fax, $comparison);
    }
    ...
    public function filterByNotes($notes = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SubjectTableMap::COL_NOTES, $notes, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \App\Models\User) {
            return $this
                ->addUsingAlias(SubjectTableMap::COL_ID, $user->getIdSubject(), $comparison);
