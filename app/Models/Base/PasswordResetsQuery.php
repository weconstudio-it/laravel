...
abstract class PasswordResetsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Models\Base\PasswordResetsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Models\\PasswordResets', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = PasswordResetsTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return ChildPasswordResets A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildPasswordResets $obj */
            $obj = new ChildPasswordResets();
            $obj->hydrate($row);
            PasswordResetsTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PasswordResetsTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(PasswordResetsTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(PasswordResetsTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    {
        if ($passwordResets) {
            $this->addUsingAlias(PasswordResetsTableMap::COL_ID, $passwordResets->getId(), Criteria::NOT_EQUAL);
        }
    ...
    {
        return $this->addUsingAlias(PasswordResetsTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PasswordResetsTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PasswordResetsTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PasswordResetsTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(PasswordResetsTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PasswordResetsTableMap::COL_CREATED_AT);
    }
